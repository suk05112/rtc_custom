 ...
 * and call view.
 */
public class WatchActivity extends Activity implements AppRTCClient.SignalingEvents,
    ...
    private boolean watchControlFragmentVisible = true;
    private long watchStartedTimeMs = 0;
    ...
    // Controls
    //화면전환, 음소거, 끊기 버튼
    private CallFragment watchFragment;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        watchFragment = new CallFragment();
        ...
        watchFragment.setArguments(intent.getExtras());
        hudFragment.setArguments(intent.getExtras());
        // Activate call and HUD fragments and start the call.
        FragmentTransaction ft = getFragmentManager().beginTransaction();
        ft.add(R.id.call_fragment_container, watchFragment);
        ...
        peerConnectionClient = new PeerConnectionClient(
                getApplicationContext(), eglBase, peerConnectionParameters, WatchActivity.this);
    ...
    private void toggleCallControlFragmentVisibility() {
        if (!iceConnected || !watchFragment.isAdded()) {
            return;
        }
        // Show/hide call control fragment
        watchControlFragmentVisible = !watchControlFragmentVisible;
        FragmentTransaction ft = getFragmentManager().beginTransaction();
        if (watchControlFragmentVisible) {
    ...
    private void startCall() {
        ...
        watchStartedTimeMs = System.currentTimeMillis();
    ...
    private void callConnected() {
        final long delta = System.currentTimeMillis() - watchStartedTimeMs;
